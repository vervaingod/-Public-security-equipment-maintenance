				...
				<table>
					<tr>
						...
						<td><input type="text" id="search_announcement_name"
							name="search_announcement_name" /></td>
						<td>发布时间：</td>
						<td><input type="text" id="search_announcement_time"
							name="search_announcement_time" /></td>
						<td><input type="button" class="clickbutton" value="搜索"></td>
					</tr>
				</table>
			</form>
			<form action="AddAnnouncementServlet">
				...
				<div class="pager-header">
					<div class="header-nav">
						<a href="./SystemAnnouncementServlet?pageno=1">首页</a> <a
							href="./SystemAnnouncementServlet?pageno=<%=pageBean.getPageno() - 1%>">上一页</a>
						<a
							href="./SystemAnnouncementServlet?pageno=<%=pageBean.getPageno() + 1%>">下一页</a>
						<a
							href="./SystemAnnouncementServlet?pageno=<%=pageBean.getMaxpage()%>">尾页</a>
					</div>
				</div>
				<%
					} else {
