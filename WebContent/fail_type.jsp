	...
	<div class="page-body">
		...
		<div class="page-content">
			...
			<table class="listtable">
				...
				<caption>
					<a class="clickbutton" href="./FailTypeServlet?type=1">新增故障</a>
				</caption>
				<tr class="listheader">
					<th>类别编号</th>
					<th>类别名称</th>
			...
			%>
			<form action="./UpdateFailTypeServlet">
				<fieldset style="display: <%=display%>">
					<legend>故障信息</legend>
					<table class="formtable">
						<tr>
							<td>故障编号:</td>
							<td><%=request.getAttribute("fail_type_id")%><input
								type="text" name="fail_type_id" id="fail_type_id"
								value="<%=request.getAttribute("fail_type_id")%>"
								style="display: none" /></td>
						</tr>
						<tr>
							<td>故障名称:</td>
							<td><input id="fail_type_name" type="text"
								name="fail_type_name" placeholder="" maxlength="25"
								value=<%=request.getAttribute("fail_type_name") != null ? request
					.getAttribute("fail_type_name") : ""%>></td>
						</tr>
						<tr>
							<td>服务费:</td>
							<td><input id="fail_type_service_fee" type="text"
								name="fail_type_service_fee" placeholder="" maxlength="25"
								value=<%=request.getAttribute("fail_type_service_fee") != null ? request
					.getAttribute("fail_type_service_fee") : ""%>></td>
						</tr>
						<tr>
