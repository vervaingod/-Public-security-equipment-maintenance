...
<body>
	...
	<div class="page-body">
		...
		<div class="page-content">
			...
			%>
			<form action="./ConfirmMaintenanceByMaintenanceID">
				<fieldset>
					<legend>
					...
					<table class="formtable">
						...
						<tr>
							...
							<td>联系电话:</td>
							<td><%=dispatchBean.getDispatch_maintenance_phone()%></td>
							<td>预计到达时间:</td>
					...
					<table class="formtable">
						...
						<tr>
							<td>设备名称:</td>
							<td><%=maintenanceBean.getMaintenance_equipment()%></td>
							<td>是否联网备案:</td>
							<td><%=request.getAttribute("record")%></td>
						</tr>
						<tr>
							<td>IP地址:</td>
							<td><%=maintenanceBean.getMaintenance_IP()%></td>
							<td>MAC地址:</td>
							<td><%=maintenanceBean.getMaintenance_MAC()%></td>
						</tr>
						<tr>
							<td>设备故障描述:</td>
							<td><%=maintenanceBean.getMaintenance_description()%></td>
						...
						<tr>
							...
							<td><%=request.getAttribute("user_name")%></td>
							<td>完工时间:</td>
							<td><%=maintenanceBean.getMaintenance_completion()%></td>
						</tr>
						<tr>
							<td>维修项目:</td>
						</tr>
					...
					<table class="formtable">
						...
						<tr>
							<td colspan="2" class="command"><input type="submit"
								class="clickbutton" value="确认" /> <input type="reset"
