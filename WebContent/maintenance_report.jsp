...
<body>
	...
	<div class="page-body">
		...
		<div class="page-content">
			...
			<form action="./MaintenanceReportServlet">
				<fieldset>
					<legend><%=request.getAttribute("message") != null ? request
					.getAttribute("message") : ""%></legend>
					<table class="formtable">
						<%
							DepartmentDao departmentDao = new DepartmentDaoImpl();
							String department_name = departmentDao
									.findDepartmentById(peopleBean.getUser_id());
						%>
						<tr>
							<td>报修单位:</td>
							<td><input id="maintenance_department"
								name="maintenance_department" type="text" placeholder=""
								maxlength="25" readonly="readonly" value="<%=department_name%>" /></td>
						</tr>
						<tr>
							<td>报修人:</td>
							<td><input id="maintenance_name" type="text"
								name="maintenance_name" placeholder="" maxlength="25"
								value="<%=peopleBean.getUser_name()%>" /></td>
						</tr>
						<tr>
							<td>报修电话:</td>
							<td><input id="maintenance_phone" type="text"
								name="maintenance_phone" placeholder="" maxlength="25"
								value="<%=peopleBean.getUser_phone()%>" /></td>
						</tr>
						<%
						...
						<tr>
							<td>选择报修公司：</td>
							<td><select name="maintenance_unit">
									<%
						...
						<tr>
							<td>故障描述:</td>
							<td><textarea id="maintenance_description" maxlength="200"
									rows="5" name="maintenance_description" cols="60"
									placeholder="200字以内的文字描述"></textarea></td>
						</tr>
						<tr>
							<td colspan="2" class="command"><input type="submit"
								value="提交" class="clickbutton" /> <input type="reset"
