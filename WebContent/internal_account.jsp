...
<body>
	...
	<div class="page-body">
		...
		<div class="page-content">
			...
			<form action="./UpdateUserByUsernameServlet">
				<fieldset style="display: <%=request.getAttribute("display")%>">
					<legend>员工信息</legend>
					<table class="formtable">
						<tr>
							<td>账号:</td>
							<td><%=request.getAttribute("user_username")%><input
								id="user_username" name="user_username" type="text"
								value=<%=request.getAttribute("user_username")%>
						...
						<tr>
							...
							<td><input id="user_name" type="text" name="user_name"
								...
								value=<%=request.getAttribute("user_name") != null ? request
					.getAttribute("user_name") : ""%>></td>
						</tr>
						<tr>
							<td>联系电话:</td>
							<td><input id="user_phone" type="text" name="user_phone"
								placeholder="11位数字" maxlength="25"
								value=<%=request.getAttribute("user_phone") != null ? request
					.getAttribute("user_phone") : ""%>></td>
						</tr>
						<tr>
