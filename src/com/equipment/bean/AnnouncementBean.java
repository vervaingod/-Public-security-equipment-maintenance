...
public class AnnouncementBean {
	...
	private int announcement_state;
	...
	public int getAnnouncement_state() {
		return announcement_state;
	}

	public void setAnnouncement_state(int announcement_state) {
		this.announcement_state = announcement_state;
	}
